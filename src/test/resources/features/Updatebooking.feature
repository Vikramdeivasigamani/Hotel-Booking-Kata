  ...
  Scenario Outline: Successfully update the customer's phone number
   ...
   Scenario Outline: Successfully update the customer's email
    ...
    Examples:
     ...
     @negative @update
      Scenario Outline: Authentication failed due to invalid booking id
    ...
    Examples: 
       ...
       | xyz       | xyz456token  | unauthorized    |
        ...
        Scenario Outline: Authentication failed due to cancelled booking id
    ...
    @negative @update  
       Scenario Outline: Authentication failed due to invalid token code
    ...
    @negative @update
      Scenario Outline: Authentication failed due to expired token code
